    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-md mx-auto p-5 pb-10">
        <div className="mb-5">
          ...
          <h1 className="text-3xl font-bold mb-2">日本株ランキング・個別株分析</h1>
          <p className="text-sm text-slate-300">
            個別株の分析、推奨銘柄、テンバガー候補を確認できます。分析ツールもこの株階層にまとめています。
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <Link href="/learning" className="rounded-2xl border border-emerald-700 bg-emerald-950 p-4">
            <div className="text-2xl mb-1">📈</div>
            <div className="font-bold text-white">AI学習</div>
            <div className="text-xs text-emerald-100 mt-1">株の勝率・成績確認</div>
          </Link>
          <Link href="/historical-backtest" className="rounded-2xl border border-purple-700 bg-purple-950 p-4">
            <div className="text-2xl mb-1">🧪</div>
            <div className="font-bold text-white">バックテスト</div>
            <div className="text-xs text-purple-100 mt-1">株の過去データ検証</div>
          </Link>
          <Link href="/strategy-lab" className="col-span-2 rounded-2xl border border-cyan-700 bg-cyan-950 p-4">
            <div className="text-2xl mb-1">🧭</div>
            <div className="font-bold text-white">Strategy Lab</div>
            <div className="text-xs text-cyan-100 mt-1">株の戦略比較・検証</div>
          </Link>
        </div>

        <div className="mb-5 flex gap-2">
          <Link href="/" className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-xs text-slate-300">← ホーム</Link>
          <Link href="/etf" className="rounded-lg border border-cyan-800 bg-cyan-950/40 px-3 py-2 text-xs text-cyan-200">ETFランキング →</Link>
        </div>
